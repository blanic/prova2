...
public class UserValidator implements Validator {
	...
	final Integer MAX_PRES_LENGTH = 3000;
	...
	public void validate(Object o, Errors errors) {
		...
		String presentazione = user.getPresentazione();
		...
		if (presentazione.length() > MAX_PRES_LENGTH)
			errors.rejectValue("presentazione", "size");
	}
